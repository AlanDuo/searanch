...
public class DataAnalysisServiceImpl implements DataAnalysisService {
    ...
    public Map<String,OrderSalesAndQuantityVO> provinceInitialize(){
        ...
        map.put("安徽省",saleVO);
        map.put("山东省",saleVO);
        map.put("新疆维吾尔自治区",saleVO);
        map.put("江苏省",saleVO);
        map.put("浙江省",saleVO);
        map.put("江西省",saleVO);
        map.put("湖北省",saleVO);
        map.put("广西壮族自治区",saleVO);
        map.put("甘肃省",saleVO);
        map.put("山西省",saleVO);
        map.put("内蒙古自治区",saleVO);
        map.put("陕西省",saleVO);
        map.put("吉林省",saleVO);
        map.put("福建省",saleVO);
        map.put("贵州省",saleVO);
        map.put("广东省",saleVO);
        map.put("青海省",saleVO);
        map.put("西藏自治区",saleVO);
        map.put("四川省",saleVO);
        map.put("宁夏回族自治区",saleVO);
        map.put("海南省",saleVO);
        map.put("台湾省",saleVO);
        map.put("香港特别行政区",saleVO);
        map.put("澳门特别行政",saleVO);
        map.put("南海诸岛",saleVO);
        return map;
    }
}
